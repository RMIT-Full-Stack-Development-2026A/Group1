...
const GameBoard = lazy(() => import("@/pages/Player/GameBoard/GameOffline/index"));
const GameOnline = lazy(() => import('@/pages/Player/GameBoard/GameOnline/index'));
...
const RedirectAuthenticatedUser = ({ children }) => {
    ...
    if (isAuthenticated && user != null) {
        const redirectPath = user.role === "ADMIN" ? "/admin" : "/lobby";
