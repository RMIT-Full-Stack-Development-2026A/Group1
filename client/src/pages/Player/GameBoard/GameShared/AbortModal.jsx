 ...
 */
const AbortModal = ({ isOpen, gameMode, isSaving, onConfirm, onCancel }) => {
        ...
        <div className="fixed inset-0 z-200 bg-deep-bg/90 flex items-center justify-center animate-fade-in">
            ...
            >
                ...
                <p className="font-mono text-[10px] text-[#879398] uppercase tracking-widest mb-2">
                    {isOnline
                        ? 'REQUESTING OPPONENT CONSENT...'
                        : 'THIS WILL SAVE YOUR PROGRESS AND END THE GAME.'}
                </p>

                {/* Online placeholder notice */}
                {isOnline && (
                    <p className="font-mono text-[9px] text-[#fad100] uppercase tracking-wider mb-4">
                        [ONLINE MODE: OPPONENT MUST AGREE — PLACEHOLDER]
                    </p>
                )}
